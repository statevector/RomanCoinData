...
if __name__ == '__main__':
	...
	model.add(Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same', 
	 	input_shape=X_train.shape[1:])) # reduced from 16 and improved
	model.add(MaxPooling2D(pool_size=(3, 3)))
	model.add(Conv2D(8, kernel_size=(3, 3), activation='relu', padding='same'))
	model.add(MaxPooling2D(pool_size=(3, 3)))  # reduced from 16 and improved
	...
	model.compile(loss=rmse, optimizer=adam, metrics=[r2, rmse])
	print(model.summary())
